      ...
      <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-6 mb-5">
        <div className="flex flex-col md:flex-row gap-4 items-end">
          ...
          <div className="flex-1">
            <label className="block text-xs font-medium text-gray-500 mb-1.5">Add New Debt</label>
            <input
              type="text"
              placeholder="Bank"
              value={creditor}
          ...
          <div className="flex-1 relative">
            ...
            <div className="flex items-center border border-gray-200 rounded-lg overflow-hidden focus-within:ring-2 focus-within:ring-[#010221]/20 focus-within:border-[#010221] transition-all">
              <button
                ...
                className="px-3 py-2 text-gray-400 bg-gray-50 border-r border-gray-200 hover:text-[#010221] transition-colors"
              >
        ...
        <div className="flex justify-end mt-4">
          <button
            onClick={handleAdd}
            disabled={loading}
            className="bg-[#010221] text-white text-sm font-medium px-5 py-2 rounded-lg hover:bg-[#010221]/85 active:scale-95 transition-all whitespace-nowrap disabled:opacity-60 disabled:cursor-not-allowed"
          >
